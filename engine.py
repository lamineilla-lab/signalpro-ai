...
def get_dynamic_mexc_symbols(limit: int = 50):
    """
    Essaie de récupérer automatiquement les contrats USDT disponibles sur MEXC.
    Si MEXC ne répond pas correctement, l'app utilise DEFAULT_SYMBOLS.
    """
    try:
        ...
        for item in data.get("data", []):
            ...
            if quote_coin == "USDT" and state == 0:
